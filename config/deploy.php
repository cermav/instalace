...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'https://gitlab.code8.cz/burt/drmouse.git',
    ],
    ...
    */
    ...
    'hosts' => [
        '10.0.0.9' => [
            'deploy_path' => '/var/www/drmouse',
            'user'         => 'deployer',
            'port'  => 22,
            //'configFile'   => 'c:\Users\burt\.ssh\config',
            'identityFile' => 'c:\Users\burt\.ssh\id_rsa_deployer.ppk',
