...
class HelperController extends Controller
{
    ...
    {
        return $doctor
            ->where('working_doctors_count', '!=', null)
            ->orWhere('nurses_count', '!=', null)
            ->orWhere('other_workers_count', '!=', null)
            ->count() > 0;
    }
    ...
    {
        $totalCount = 0;
        $properties = $doctor->user->properties->groupBy(
